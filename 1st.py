...
# Step C: Parse numeric values & FAOSTAT Month codes (7001=Jan ... 7012=Dec)
...
# ==============================================================================
# 3. TRAIN ML MODEL (Month-over-Month Growth Rate)
# ==============================================================================
...
# Reconstruct predicted CPI values from growth rate
reconstructed_cpi = []
...
next_features = pd.DataFrame(
    [{"Month": next_month, "Prev_MoM_Lag1": last_mom, "Prev_MoM_Lag2": prev_mom}]
)
